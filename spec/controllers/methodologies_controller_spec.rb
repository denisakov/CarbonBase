...
describe MethodologiesController do
  ...
  describe "GET index" do
    it "assigns all methodologies as @methodologies" do
      ...
      assigns(:methodologies).should eq([methodology])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new methodology as @methodology" do
      ...
      assigns(:methodology).should be_a_new(Methodology)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created methodology as @methodology" do
        post :create, {:methodology => valid_attributes}, valid_session
        assigns(:methodology).should be_a(Methodology)
        assigns(:methodology).should be_persisted
      end

      it "redirects to the created methodology" do
        post :create, {:methodology => valid_attributes}, valid_session
        response.should redirect_to(Methodology.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved methodology as @methodology" do
        ...
        Methodology.any_instance.stub(:save).and_return(false)
        post :create, {:methodology => {}}, valid_session
        assigns(:methodology).should be_a_new(Methodology)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested methodology" do
        methodology = Methodology.create! valid_attributes
        # Assuming there are no other methodologies in the database, this
        # specifies that the Methodology created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Methodology.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => methodology.to_param, :methodology => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the methodology" do
        methodology = Methodology.create! valid_attributes
        put :update, {:id => methodology.to_param, :methodology => valid_attributes}, valid_session
        response.should redirect_to(methodology)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the methodology as @methodology" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Methodology.any_instance.stub(:save).and_return(false)
        put :update, {:id => methodology.to_param, :methodology => {}}, valid_session
        assigns(:methodology).should eq(methodology)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the methodologies list" do
      methodology = Methodology.create! valid_attributes
      delete :destroy, {:id => methodology.to_param}, valid_session
      response.should redirect_to(methodologies_url)
    end
  end
